...
const tubeVideo = async (categoryId) => {
  ...
  if (videos.length === 0) {
    ...
    noDataDiv.innerHTML = `
          ...
          <p class="text-3xl font-bold text-[#171717] text-center mt-8">Oops!! Sorry, There is no <br> content here</p>
    `;
                ...
                <div class="flex items-start gap-3 mt-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 items-center mt-2">
                            ...
                            <p>${video.authors[0]?.verified ? `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <p class="text-sm text[#171717B2] mt-2">${video.others?.views} views</p>
                    </div>
                </div>
        `;
